...
class SnakeNN:
    def __init__(self, initial_games = 10000, test_games = 1000, goal_steps = 2000, lr = 0.0002, filename = 'snake_nn_2.tflearn'):
    ...
    def get_game_action(self, snake, action):
        ...
        for pair in self.vectors_and_keys:
            if pair[0] == new_direction.tolist():
                game_action = pair[1] # there is some weird scope stuff going on here. what the heck // test 32
        return game_action
